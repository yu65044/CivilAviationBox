$(function(){
	...
	function n()
	{
		...
		if($(document).find(".J_menuTab").each(
			function()
			{
				return $(this).data("id")==t? ( $(this).hasClass("active")||($(this).addClass("active").siblings(".J_menuTab").removeClass("active"),e(this),$(".J_mainContent .J_iframe").each(function(){return $(this).data("id")==t?($(this).show().siblings(".J_iframe").hide(),!1):void 0})),n=!1,!1):void 0}),n){
	...
	function s()
	{
		...
		if($(this).parents(".J_menuTab").hasClass("active"))
		{
			if($(this).parents(".J_menuTab").next(".J_menuTab").size())
			{
				...
				$(".J_mainContent .J_iframe").each(function(){return $(this).data("id")==i?($(this).show().siblings(".J_iframe").hide(),!1):void 0});
				...
				$(".J_mainContent .J_iframe").each(function(){return $(this).data("id")==t?($(this).remove(),!1):void 0})
			}
	...
	function d()
	{
		...
		{
			var t=$(this).data("id");
			$(".J_mainContent .J_iframe").each(function(){return $(this).data("id")==t?($(this).show().siblings(".J_iframe").hide(),!1):void 0}),
	...
	$(document).on("click",".J_menuTabs .J_menuTab i",s),

	$(document).on("click",".J_tabCloseOther",r),

	$(document).on("click",".J_tabShowActive",o),

	$(document).on("click",".J_menuTabs .J_menuTab",d),

	$(document).on("dblclick",".J_menuTabs .J_menuTab",c),

	$(document).on("click",".J_tabLeft",a),

	$(document).on("click",".J_tabRight",i),

	$(document).on("click",".J_tabCloseAll",
		function()
		{
